          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _this2.photos.push(photo);
                alert(photo);
                _this2.$router.push({
                  path: "/page/release/ReleaseImgEdit",
                  name: "ReleaseImgEdit",
                  params: {
                    photos: _this2.photos
                  }
                });
              ...
              case 2:
                ...
                if (photos.length) {
                  _this3.$router.push({
                    ...
                    name: "ReleaseImgEdit",
                    params: {
                      photos: _this3.photos.concat(photos)
                    }
                  });
                }
                _this3.releaseShowState = false;
...
/* harmony default export */ var util = ({
  ...
  wechatLogin: function wechatLogin(vm) {
    var _this2 = this;

    var scope = "snsapi_userinfo",
        state = "_" + +new Date();
    Wechat.auth(scope, state, function () {
...
/* harmony default export */ var UserIndex = ({
  ...
  methods: {
    ...
    toPageUrl: function toPageUrl(cell) {
      var _this = this;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-729e97e3","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/user/SetUserInfo.vue
...
/* harmony default export */ var MyFollow = ({
  ...
  methods: {
    toDetail: function toDetail(userId) {
      this.$router.push({
    ...
    onInfinite: function onInfinite(done) {
      ...
      setTimeout(asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee3() {
        var data;
        return regenerator_default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return util.getData({
                  url: '/users/myfollows?loginid=' + _this2.userInfo.id + '&pages=' + _this2.pageNum + '&rowsmax=10',
                  method: "get"
                });
              ...
              case 2:
                ...
                _this2.$refs.scroller.finishInfinite(2);
                return _context3.abrupt('return', false);

              case 6:
                _this2.myFollowList = _this2.myFollowList.concat(data);
                _this2.myFollowList.forEach(function (items) {
                  items.forEach(function (item) {
                    item.gender == 1 ? item.sex = "boy" : item.sex = "girl";
                  });
                });
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-e2a17b42","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/user/MyFollow.vue
var MyFollow_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"MyFollow"},[_c('scroller',{ref:"scroller",class:_vm.myFollowList.length<10 ? 'hide-scroller':'',attrs:{"on-infinite":_vm.onInfinite,"noDataText":"我是有底线的..."}},[_c('x-header',{staticClass:"x-header",attrs:{"left-options":{backText: ''}}},[_vm._v("我的关注")]),_vm._v(" "),_c('div',{staticClass:"MyFollowList"},_vm._l((_vm.myFollowList),function(myFollow,index){return _c('flexbox',{key:index,staticClass:"flexbox",nativeOn:{"click":function($event){return _vm.toDetail(myFollow[0].id)}}},[_c('flexbox-item',{attrs:{"span":2}},[_c('img',{staticClass:"avatar",attrs:{"src":myFollow[0].logos || 'static/img/default-avatar.png',"alt":""}})]),_vm._v(" "),_c('flexbox-item',{attrs:{"span":7}},[_c('div',[_c('div',{staticClass:"username"},[_vm._v("\n            "+_vm._s(myFollow[0].nicknames)+"\n            "),(myFollow[0].sex == 'girl')?_c('i',{staticClass:"iconfont icon-nvsheng"}):_c('i',{staticClass:"iconfont icon-nansheng"})]),_vm._v(" "),_c('div',{staticClass:"direc"},[_vm._v(_vm._s(myFollow[0].remarks || '当前大咖有点儿懒。。。'))])])]),_vm._v(" "),_c('flexbox-item',{staticClass:"x-button-box",attrs:{"span":3}},[_c('x-button',{staticClass:"x-button",attrs:{"mini":"","gradients":['rgb(525,97,66)', 'rgb(525,97,66)']},nativeOn:{"click":function($event){$event.stopPropagation();return _vm.follow(myFollow[0],index)}}},[_vm._v("已关注")])],1)],1)}),1)],1)],1)}
...
/* harmony default export */ var MyRelease = ({
  ...
  created: function () {
    var _ref = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
      ...
      var params, userInfo, data, imgList;
      return regenerator_default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
...
/* harmony default export */ var MyCollect = ({
  ...
  created: function () {
    var _ref = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
      var userInfo, params, data, _data;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return util.getData({
                url: '/materials/details?loginid=' + userInfo.id + '&sources_id=' + params.id,
                method: "get"
              });
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 6;
              return util.getData({
                url: '/users/myfans?loginid=' + this.userInfo.id + '&pages=' + this.pageNum + '&rowsmax=10',
                method: "get"
              });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return util.getData({
                  url: '/users/myfans?loginid=' + _this2.userInfo.id + '&pages=' + _this2.pageNum + '&rowsmax=10',
                  method: "get"
                });
              ...
              case 6:
                _this2.myFanList = _this2.myFanList.concat(data);
                _this2.myFanList.forEach(function (items) {
                  items.forEach(function (item) {
                    item.gender == 1 ? item.sex = "boy" : item.sex = "girl";
                  });
                });
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-b4c1187c","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/user/MyFan.vue
var MyFan_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"MyFollow"},[_c('scroller',{ref:"scroller",class:_vm.myFanList.length<10 ? 'hide-scroller':'',attrs:{"on-infinite":_vm.onInfinite,"noDataText":"我是有底线的..."}},[_c('x-header',{staticClass:"x-header",attrs:{"left-options":{backText: ''}}},[_vm._v("我的粉丝")]),_vm._v(" "),_c('div',{staticClass:"MyFollowList"},_vm._l((_vm.myFanList),function(myFan,index){return _c('flexbox',{key:index,staticClass:"flexbox",nativeOn:{"click":function($event){return _vm.toDetail(myFan[0].id)}}},[_c('flexbox-item',{attrs:{"span":2}},[_c('img',{staticClass:"avatar",attrs:{"src":myFan[0].logos || 'static/img/default-avatar.png',"alt":""}})]),_vm._v(" "),_c('flexbox-item',{attrs:{"span":7}},[_c('div',[_c('div',{staticClass:"username"},[_vm._v("\n              "+_vm._s(myFan[0].nicknames)+"\n              "),(myFan[0].sex == 'girl')?_c('i',{staticClass:"iconfont icon-nvsheng"}):_c('i',{staticClass:"iconfont icon-nansheng"})]),_vm._v(" "),_c('div',{staticClass:"direc"},[_vm._v(_vm._s(myFan[0].remarks || '当前大咖有点儿懒。。。'))])])]),_vm._v(" "),_c('flexbox-item',{staticClass:"x-button-box",attrs:{"span":3}},[_c('x-button',{directives:[{name:"show",rawName:"v-show",value:(myFan[0].followed),expression:"myFan[0].followed"}],staticClass:"x-button",attrs:{"mini":"","gradients":['rgb(525,97,66)', 'rgb(525,97,66)']},nativeOn:{"click":function($event){$event.stopPropagation();return _vm.follow(myFan[0],index)}}},[_vm._v("已关注")]),_vm._v(" "),_c('x-button',{directives:[{name:"show",rawName:"v-show",value:(!myFan[0].followed),expression:"!myFan[0].followed"}],staticClass:"x-button no-follow",attrs:{"mini":""},nativeOn:{"click":function($event){$event.stopPropagation();return _vm.follow(myFan[0],index)}}},[_vm._v("关注")])],1)],1)}),1)],1)],1)}
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-277f3316","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/user/MyIncome.vue
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return util.getData({
                  url: '/users/myaccountsdetails?loginid=' + _this.userInfo.id + '&pages=' + _this.pageNum + '&rowsmax=10',
                  method: "get"
                });
              ...
              case 6:
                _this.incomeRecordList = _this.incomeRecordList.concat(data);
                _this.incomeRecordList.forEach(function (item, index) {
                  if (item.pays_types == 'alipay') {
                    item.iconType = "icon-zhifubao";
                    item.text = '支付宝支付';
                  } else {
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                return util.getData({
                  ...
                  method: 'post',
                  param: {
                    contents: _this3.editValue,
                    updata: _this3.imgs.substring(2)
                  }
                });
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-a9be97f6","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/user/ReportOpinion.vue
      ...
      return asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                fetch('http://www.shedouwang.com/api/ajax/sendssms/?regs-' + _this.mobile + '.html').then(function (response) {
                  return response.json();
                }).then(function (result) {
                  if (result.return_code == "success") {
                    var data = result.return_data;
                    _this.$vux.toast.show({
                      text: data,
                      type: "text"
                    });
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-2792c547","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/user/MobileInfoVerification.vue
var MobileInfoVerification_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"MobileInfoLogin"},[_c('x-header',{staticClass:"x-header",attrs:{"left-options":{backText: ''}}}),_vm._v(" "),_c('div',{staticClass:"content-box"},[_c('group',[_c('h1',{staticClass:"login-title",attrs:{"slot":"title"},slot:"title"},[_vm._v("填写验证码")]),_vm._v(" "),_c('div',{staticClass:"text"},[_vm._v("短信验证码已发送至  "+_vm._s(_vm.mobile))]),_vm._v(" "),_c('x-input',{staticClass:"mobile",attrs:{"title":"验证","placeholder":"请输入验证码"},model:{value:(_vm.sign),callback:function ($$v) {_vm.sign=$$v},expression:"sign"}},[(_vm.state)?_c('span',{staticClass:"get-verification-code",attrs:{"slot":"right"},slot:"right"},[_vm._v(_vm._s(_vm.time)+"秒后重新获取")]):_c('span',{staticClass:"get-verification-code-btn",attrs:{"slot":"right"},on:{"click":_vm.resetSign},slot:"right"},[_vm._v("重新获取")])]),_vm._v(" "),(_vm.$route.query.type == 'register')?_c('x-button',{staticClass:"login-commit",nativeOn:{"click":function($event){return _vm.register($event)}}},[_vm._v("注册")]):_vm._e(),_vm._v(" "),(_vm.$route.query.type == 'login')?_c('x-button',{staticClass:"login-commit",nativeOn:{"click":function($event){return _vm.login($event)}}},[_vm._v("登录")]):_vm._e(),_vm._v(" "),(_vm.$route.query.type == 'resetPwd')?_c('x-button',{staticClass:"login-commit",nativeOn:{"click":function($event){return _vm.resetPwd($event)}}},[_vm._v("提交")]):_vm._e()],1)],1)],1)}
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-7e73814b","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/user/MobileNumLogin.vue
...
var MobileNumLogin_staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"statement-box"},[_vm._v("\n        登录或注册即同意舍豆\n        "),_c('span',[_vm._v("《用户服务协议》")])])}]
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-6c531071","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/user/Register.vue
...
var Register_staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"statement-box"},[_vm._v("\n        登录或注册即同意舍豆\n        "),_c('span',[_vm._v("《用户服务协议》")])])}]
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/page/user/BandUserInfo.vue
...
/* harmony default export */ var BandUserInfo = ({
  data: function data() {
    return {
      pwdShowState: false,
      password: "password",
  ...
  methods: {
    ...
    commit: function commit() {
      ...
      return asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
        var wechatUserinfo, mobile, pwd, mobile_code, data;
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                wechatUserinfo = _this2.$route.params.wechatUserinfo;
                mobile = _this2.mobile;
                pwd = _this2.pwd;
                mobile_code = _this2.mobile_code;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vux-loader/src/script-loader.js!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/page/user/BandUserInfo.vue
...
/* harmony default export */ var user_BandUserInfo = ({
  data: function data() {
    return {
      pwdShowState: false,
      password: "password",
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-b1d6e8f6","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/user/BandUserInfo.vue
var BandUserInfo_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"BandUserInfo"},[_c('x-header',{staticClass:"x-header",attrs:{"left-options":{backText: ''}}}),_vm._v(" "),_c('div',{staticClass:"content-box"},[_c('group',[_c('h1',{staticClass:"login-title",attrs:{"slot":"title"},slot:"title"},[_vm._v("完善信息")]),_vm._v(" "),_c('x-input',{staticClass:"mobile",attrs:{"title":"手机","placeholder":"请输入手机号"},model:{value:(_vm.mobile),callback:function ($$v) {_vm.mobile=$$v},expression:"mobile"}}),_vm._v(" "),_c('x-input',{staticClass:"mobile",attrs:{"title":"验证","placeholder":"请输入验证码"},model:{value:(_vm.mobile_code),callback:function ($$v) {_vm.mobile_code=$$v},expression:"mobile_code"}},[(_vm.state)?_c('span',{staticClass:"get-verification-code",attrs:{"slot":"right"},slot:"right"},[_vm._v(_vm._s(_vm.time)+"秒后重新获取")]):_c('span',{staticClass:"get-verification-code-btn",attrs:{"slot":"right"},on:{"click":_vm.getSign},slot:"right"},[_vm._v("获取验证码")])]),_vm._v(" "),_c('x-input',{staticClass:"pwd",attrs:{"type":_vm.password,"title":"密码","placeholder":"请设置登录密码"},model:{value:(_vm.pwd),callback:function ($$v) {_vm.pwd=$$v},expression:"pwd"}},[_c('i',{directives:[{name:"show",rawName:"v-show",value:(_vm.pwdShowState),expression:"pwdShowState"}],staticClass:"iconfont icon-mimakejian",attrs:{"slot":"right"},on:{"click":_vm.pwdToggle},slot:"right"}),_vm._v(" "),_c('i',{directives:[{name:"show",rawName:"v-show",value:(!_vm.pwdShowState),expression:"!pwdShowState"}],staticClass:"iconfont icon-mimabukejian",attrs:{"slot":"right"},on:{"click":_vm.pwdToggle},slot:"right"})]),_vm._v(" "),_c('x-button',{staticClass:"login-commit",nativeOn:{"click":function($event){return _vm.commit($event)}}},[_vm._v("提交")])],1)],1)],1)}
var BandUserInfo_staticRenderFns = []
var BandUserInfo_esExports = { render: BandUserInfo_render, staticRenderFns: BandUserInfo_staticRenderFns }
/* harmony default export */ var page_user_BandUserInfo = (BandUserInfo_esExports);
// CONCATENATED MODULE: ./src/page/user/BandUserInfo.vue
function BandUserInfo_injectStyle (ssrContext) {
  __webpack_require__("h9ip")
}
var BandUserInfo_normalizeComponent = __webpack_require__("VU/8")
/* script */
...
/* template functional */
var BandUserInfo___vue_template_functional__ = false
/* styles */
var BandUserInfo___vue_styles__ = BandUserInfo_injectStyle
/* scopeId */
var BandUserInfo___vue_scopeId__ = null
/* moduleIdentifier (server only) */
var BandUserInfo___vue_module_identifier__ = null
var BandUserInfo_Component = BandUserInfo_normalizeComponent(
  user_BandUserInfo,
  page_user_BandUserInfo,
  BandUserInfo___vue_template_functional__,
  BandUserInfo___vue_styles__,
  BandUserInfo___vue_scopeId__,
  BandUserInfo___vue_module_identifier__
)

/* harmony default export */ var src_page_user_BandUserInfo = (BandUserInfo_Component.exports);
...
/* harmony default export */ var TakePhoto = ({
          ...
          switch (_context.prev = _context.next) {
            ...
            case 9:
              ...
              */
              ...
              if (this.userInfo) {
                designListUrl = '/materials/postslists?loginid=' + this.userInfo.id + '&topics_id=' + this.tab.id + '&pages=' + this.pageNum + '&rowsmax=10';
              } else {
                designListUrl = '/materials/postslists?topics_id=' + this.tab.id + '&pages=' + this.pageNum + '&rowsmax=10';
              }
              _context.next = 15;
              return util.getData({
                url: designListUrl,
  ...
  methods: {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                */
                ...
                if (_this2.userInfo) {
                  designListUrl = '/materials/postslists?loginid=' + _this2.userInfo.id + '&topics_id=' + _this2.tab.id + '&pages=' + _this2.pageNum + '&rowsmax=10';
                } else {
                  designListUrl = '/materials/postslists?topics_id=' + _this2.tab.id + '&pages=' + _this2.pageNum + '&rowsmax=10';
                }
                _context2.next = 7;
                return util.getData({
                  url: designListUrl,
    ...
    onInfinite: function onInfinite(done) {
      ...
      setTimeout(asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee8() {
        var designListUrl, designList;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                if (_this8.userInfo) {
                  designListUrl = '/materials/postslists?topics_id=' + _this8.tab.id + '&pages=' + _this8.pageNum + '&rowsmax=10';
                } else {
                  designListUrl = '/materials/postslists?topics_id=' + _this8.tab.id + '&pages=' + _this8.pageNum + '&rowsmax=10';
                }
                _context8.next = 4;
              ...
              case 4:
                ...
                _this8.$refs.scroller.finishInfinite(2);
                return _context8.abrupt('return', false);

              case 8:
                _this8.designList = _this8.designList.concat(designList);
                _this8.pageNum++;
                done();
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-886e4b5e","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vux-loader/src/before-template-compiler-loader.js!./node_modules/vux-loader/src/template-loader.js!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/page/release/SelectLabel.vue
...
/* harmony default export */ var src_router = ([{
  ...
  path: '/page/user/BandUserInfo',
  name: 'BandUserInfo',
  component: src_page_user_BandUserInfo,
  meta: {
    index: 29
  }
}]);
...
vue_esm["a" /* default */].use(wechatAuth, { appid: 'wxebf7146b68f2e818' });
...
//# sourceMappingURL=app.b18846fbde6be77cc7be.js.map